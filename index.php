...
$tasksNames = ["Собес в компании"," выполнить тз","сделать задания 1 разд.","встреча с другом","корм коту","пицца"];
$tasksDates = ["01.12.2019","25.12.2019","21.12.2019","22.12.2019","null","null"];
$tasksCategories = ["Раб","Раб","Учёба","Вход","Дом. дела","Дом. дела"];
$tasksDone = [false,false,true,false,false,false];
                ...
                <nav class="main-navigation">
                    <ul class="main-navigation__list">
                        ...
                        <?php foreach ($categories as $c) {
                            echo('<li><a class="main-navigation__list-item-link" href="#">' . $c . '</a></li>');
                        }
                                ?>
                    </ul>
                </nav>
            ...
            <main class="content__main">
                ...
                <div class="tasks-controls">
                    ...
                    <label class="checkbox">
                            <input class="checkbox__input visually-hidden show_completed" type="checkbox" <?php if($showCompleteTasks == 1):?> checked <?php endif;?>>
                ...
                <table class="tasks">
                    ...
                    <tr class="tasks__item task task--completed"> 
                        ...
                        </td> <td class="task__date">10.10.2019</td>
                        <td class="task__controls">
                        </td>
                    </tr>
                    <?php endif;?>

                    <!--показывать следующий тег <tr/>, если переменная $showCompleteTasks
                 равна единице-->
                </table>
            </main>
        </div>
